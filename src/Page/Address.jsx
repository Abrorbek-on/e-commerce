                ...
                <form onSubmit={handleSubmit}>
                    <div className="bg-white shadow p-6 rounded-lg mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input type="text" name="title" value={formData.title} onChange={handleChange} placeholder="Property title*" className="border p-2 rounded" required />
                            <select name="listing_type" value={formData.listing_type} onChange={handleChange} className="border p-2 rounded">
                                <option value="SALE">Sale</option>
                                <option value="RENT">Rent</option>
                            </select>
                        </div>

                        <textarea name="description" value={formData.description} onChange={handleChange} placeholder="Property Description*" className="w-full border p-2 rounded mt-4" rows="4" required />

                        <div className="mt-4">
                            <label htmlFor="category_id" className="block mb-1 font-medium">Category*</label>
                            <select name="category_id" id="category_id" value={formData.category_id} onChange={handleChange} className="border p-2 rounded w-full" required>
                    ...
                    <div className="bg-white shadow p-6 rounded-lg mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <input type="text" name="country" value={formData.country} onChange={handleChange} placeholder="Country" className="border p-2 rounded" required />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input type="text" name="latitude" value={formData.latitude} onChange={handleChange} placeholder="Latitude" className="border p-2 rounded" required />
                            <input type="text" name="longitude" value={formData.longitude} onChange={handleChange} placeholder="Longitude" className="border p-2 rounded" required />
                        </div>
                            ...
                            <MapPicker
                                setLocation={(loc) => {
                                    setFormData((prev) => ({
                                        ...
                                        map_url: `https://www.google.com/maps?q=${loc.lat},${loc.lng}`,
                                    }));
                                }}
                            />
                    ...
                    <div className="bg-white shadow p-6 rounded-lg mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <input type="number" name="discount" value={formData.discount} onChange={handleChange} placeholder="Discount" className="border p-2 rounded" required />
                        </div>
                    </div>
                    ...
                    <div className="bg-white shadow p-6 rounded-lg mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input type="number" name="build_year" value={formData.build_year} onChange={handleChange} placeholder="Build Year" className="border p-2 rounded" required />
                            <input type="text" name="map_url" value={formData.map_url} onChange={handleChange} placeholder="Map URL" className="border p-2 rounded" required />
                        </div>
                    </div>
